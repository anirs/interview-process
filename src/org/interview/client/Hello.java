	...
	public void onModuleLoad() {
        ...
        class MyHandler implements ClickHandler, KeyUpHandler {
            ...
            class ClearPersonHandler implements ClickHandler{
            	public void onClick(ClickEvent event){
            		clearPersonInforamtion();
            	}
            }
            
            class CountCallHandler implement ClickHandler{
            	public void onClick(ClickEvent event){
            		countCallLabel.setHTML(countCallService.countCall());
            	}
            }
        ...
        ClearPersonHandler cphandler = new ClearPersonHandler();
        clearPersonButton.addClickHandler(cphandler);
